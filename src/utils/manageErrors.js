 ...
 * @param {Number} databaseId - form ID
 ...
 * @returns {Object} An object mapping of errors in the format: { 'input_formID_id': { type, message } }.
 */
export const handleGravityFormsValidationErrors = (
  ...
  data?.forEach((error) => {
    const errorKey = `input_${databaseId}_${error.id}`;
